...
### Důležité pro spuštění JAR souboru:

**1. Resources složka musí být vedle JAR souboru**

**2. Pro správné zobrazení češtiny v PowerShell:**
```
[Console]::OutputEncoding = [System.Text.Encoding]::UTF8
java -jar Posledni_Tvurce.jar
```

Nebo použij **Windows Terminal** (má UTF-8 automaticky).
